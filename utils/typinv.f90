...
!  get filename argument
      ...
      NARG=IARGC()
      IF(NARG<1) THEN
        write(*,*)'Usage: "typinv <prepbufr>" will print prepbufr inventory by variable and GSI report type'
        CALL EXIT(2)
      ENDIF
      call getarg(1,file)
...
10    CALL READSB(LUBFR,IRET)
      ...
      KX = HDR(5)
      if(kx.lt.0.or.kx.ge.300) goto 10
...
!  ---------
      ...
      IF(ITOT.GT.0) call getcfmng(lubfr,'TYP',kx,'NCNW',2,str,lenstr,iret)
